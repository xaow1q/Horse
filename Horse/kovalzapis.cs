...
namespace Horse
{
    public partial class kovalzapis : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var koval = textBox3.Text;

            var addQuery = $"INSERT INTO Коваль(ФИОВ, Лошадь, Дата, Время, Коваль) VALUES ('{fio}','{loshad}','{data}','{vremya}','{koval}')";
        ...
        private void kovalzapis_Load(object sender, EventArgs e)
        {
        ...
        private void RefreshDataGrid2(DataGridView dgw)
        {
            ...
            string query = $"SELECT Имя, Фамилия, Отчество FROM Сотрудник WHERE Должность = 'Коваль'";
            SqlCommand command = new SqlCommand(query, dataBase.getConnection());
