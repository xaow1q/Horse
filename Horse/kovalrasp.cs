...
namespace Horse
{
    public partial class kovalrasp : Form
    {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView1.Columns.Add("Коваль", "Коваль");
        ...
        private void RefreshDataGrid(DataGridView dgw)
        {
            ...
            string query = $"SELECT * FROM Коваль ORDER BY Дата DESC";
        ...
        private void kovalrasp_Load(object sender, EventArgs e)
        {
            CreateColumns();
